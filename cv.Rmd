...
library(dplyr)
library(kableExtra)
knitr::opts_chunk$set(echo = TRUE, cache = F, dev = "ragg_png")
```
:::: {.columns}
...
kbl(data[-3], longtable = T, booktabs = T, linesep = "", col.names = NULL, escape = T) %>%
    kable_styling(full_width = F, latex_options = "striped", stripe_index = c(seq(2, 8, 2), 12, 15, seq(20, 35, 3), seq(38, 50, 2), 51, seq(53, 67, 2)), bootstrap_options = c("hover", "condensed", "condensed")) %>%
