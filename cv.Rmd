...
- Уверенно владею Python и основными библиотеками для DA/DS. Использую Jupiter Notebook, Git; Airflow --- для автоматизации задач; Tableau, Power BI, Data Studio --- для визуализации данных.\
...
kbl(data[-3], longtable = T, booktabs = T, linesep = "", col.names = NULL, escape = T) %>%
    kable_styling(full_width = F, latex_options = "striped", stripe_index = c(seq(2, 10, 2), 12, 15, seq(20, 35, 3), seq(37, 50, 2), seq(52, 67, 2)), bootstrap_options = c("hover", "condensed", "condensed"), font_size = 9.5) %>%
